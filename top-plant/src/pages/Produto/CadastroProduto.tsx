...
type CadastroProdutoProps = {
  // Função que o App.tsx passará para enviar o payload para a API
  handleCadastrar: (payload: any) => void
  busy: string | null
}

export function CadastroProduto({ handleCadastrar, busy }: CadastroProdutoProps) {
  ...
  const onSubmit = (e: FormEvent) => {
    ...
    // Opcional: Limpar o formulário após enviar (pode ser movido para o App.tsx)
