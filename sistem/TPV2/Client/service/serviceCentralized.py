...
def cleanClient(clientDTO: ClientDTO):
    ...
    client_clean.name = clean.personName(clientDTO.name)
...
def cleanAdress(adressDTO: AdressDTO):
    ...
    adress_clean.city = clean.addressText(adressDTO.city)
    adress_clean.neig_b = clean.addressText(adressDTO.neig_b)
